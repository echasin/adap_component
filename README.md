...
To optimize the adapcomponent application for production, run:
...
[Service Discovery and Configuration with the JHipster-Registry]: https://jhipster.github.io/documentation-archive/v4.1.0/microservices-architecture/#jhipster-registry
